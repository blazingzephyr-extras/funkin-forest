...
function onStartCountdown()
	...
	makeAnimatedLuaSprite('alt', 'characters/leaf-brother', 700, 800);
	...
	if not allowCountdown and not seenCutscene then
		...
		addAnimationByPrefix('alt', 'alt', 'LeafBrother Idle Dance');
		objectPlayAnimation('alt', 'characters/leaf-brother', true);
	end
